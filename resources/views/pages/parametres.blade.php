                ...
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-center">
                        ...
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Apparence et comportement</p>
                        </div>
                    </div>
                </div>
                <div class="p-6 space-y-4">
                    <div>
                        ...
                        <div class="grid grid-cols-3 gap-2">
                            <button class="p-3 border-2 border-blue-500 rounded-lg bg-blue-50">
                                <i class="fas fa-sun text-blue-600 mb-1"></i>
                                <p class="text-xs">Clair</p>
                            </button>
                            <button class="p-3 border border-gray-300 rounded-lg hover:border-gray-400">
                                <i class="fas fa-moon text-gray-600 mb-1"></i>
                                <p class="text-xs">Sombre</p>
                            </button>
                            <button class="p-3 border border-gray-300 rounded-lg hover:border-gray-400">
                                <i class="fas fa-adjust text-gray-600 mb-1"></i>
                    ...
                    <div>
                        ...
                        <div class="space-y-2">
                            ...
                            <label class="flex items-center justify-between">
                                <span class="text-sm text-gray-700">Son</span>
