...
class ApiController extends Controller
{
    ...
    public function dashboardApi(){
        ...
        $sommeProduitOrdinateurs = Produit::where('categorie_id', '=', 2)->count();
        $sommeProduitAutres = Produit::where('categorie_id', '=', 3)->count();
    ...
    //API Rapport de ventes avec bénéfices
    public function rapportVenteApi(){
        $user = Auth::user();
        if (!$user) {
            return response()->json([
                'message' => 'Utilisateur non authentifié'
        ...
        // Ajouter l'historique
        $this->ajouterHistorique('rapport_vente_application ' . $user->name , 'rapport_vente', 'Consultation du rapport de ventes');
        ...
        return response()->json([
            'message' => 'Rapport de ventes récupéré avec succès',
            'produitRapports' => $produitRapports,
